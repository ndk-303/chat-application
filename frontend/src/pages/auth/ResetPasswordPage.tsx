    ...
    return (
      <AuthLayout>
        <div className="text-center py-4">
          ...
          <Link
            to="/login"
            className="inline-block w-full py-2.5 rounded-[0.25rem] bg-[#0068FF] text-white font-semibold text-sm text-center transition-all hover:bg-[#0052CC] hover:shadow-lg hover:shadow-[#0068FF]/25 no-underline"
          >
            Đăng nhập ngay
          </Link>
        </div>
